...
CC		:= g++ -std=c++11 
LINKER		:= g++ -o 
CFLAGS		:= -c -Wall -g -mfloat-abi=hard -mfpu=neon -O3
LFLAGS		:= -lm -lrt -lpthread -lroboticscape

SOURCES		:= $(wildcard *.cpp) INPUTS/INPUTS.cpp RECEIVER/RECEIVER.cpp DATALOG/DATALOG.cpp COMS/COMS.cpp INS/INS.cpp  INS/IMU_EKF.cpp                               
